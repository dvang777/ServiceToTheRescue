...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['multiplebgs'] = function() {
        // Setting multiple Imagess AND a color on the background shorthand property
    ...
    tests['borderImages'] = function() {
        return testPropsAll('borderImages');
    };
    ...
    tests['cssgradients'] = function() {
         ...
         * dev.w3.org/csswg/css3-Imagess/#gradients-
         */
        ...
        return contains(mStyle.backgroundImages, 'gradient');
    };
